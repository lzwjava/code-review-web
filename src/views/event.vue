    ...
    <section id="intro" class="intro">
      <div class="intro__content">
        ...
        <div class="intro__card">
          ...
          <p class="intro__detail">周日 1pm - 8:30pm</p>
        </div>
        <div class="intro__card">
       ...
       <div class="speaker-list">
        ...
        <div class="speaker__card">
          <div class="speaker__content">
            ...
            <p class="detail">微博 <a href="http://weibo.com/u/5384637337" target="_blank">@标哥的技术博客</a>。标哥对 iOS 技术极其狂热，也热爱写 <a href="http://www.henishuo.com/" target="_blank">博客</a>，热爱分享，有强烈的代码洁癖，追求极致。
